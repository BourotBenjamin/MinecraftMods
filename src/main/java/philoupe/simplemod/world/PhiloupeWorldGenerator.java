package philoupe.simplemod.world;
...
public class PhiloupeWorldGenerator implements IWorldGenerator {
	    ...
	    private void GenerateOverworld(Random random, int x, int z, World world) {
	            this.addOreSpawn(ModBlocks.philoupeBlock, world, random, x, z, 10, 15, 5, 0, 128);
	    }
